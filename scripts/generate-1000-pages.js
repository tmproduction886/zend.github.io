...
function generateKeywordCombinations() {
  ...
  if (stillRemaining > 0) {
    ...
    const baseCombos = combinations.slice(0, Math.min(stillRemaining * 2, combinations.length))
...
let fileContent = `// Auto-generated file: ${TARGET_PAGES} programmatic SEO pages
